...
(function () {
  ...
  var WORDS = [
    ...
    ['НУ ПРОСТИ',          'из-за тебя начался дождь'],
    ['ПРОСТИИИ',           'я уже плачу, вообще-то'],
    ['ПРОСТИ МЕНЯ',        'всё, гроза, ты доволен?'],
    ['ПРОСТИ',             'я не уйду, пока не простишь']
  ];

  var NO_LABELS = ['Нет', 'Всё ещё нет', 'Нет...', 'Не-а', 'Нет?', 'Ну нет'];

  var FORGIVEN_WORD = 'СПАСИБО';
  var FORGIVEN_SUB  = 'котик перестал плакать';
